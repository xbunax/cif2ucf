...
class writeucf:
    def __init__(self, super_crystal, origin_crystal, ucf_path, magmom):
    ...
    def write_Atoms_num(self,atom_type, mat, lc, hc):
    ...
    def write_interactions(self, exchange, n, isotropic):
